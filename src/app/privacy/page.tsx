  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 text-sm text-stone-700 dark:text-stone-300">
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-stone-900 dark:text-stone-100">What we collect</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-stone-900 dark:text-stone-100">How we use it</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-stone-900 dark:text-stone-100">Third-party services</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-stone-900 dark:text-stone-100">Your data</h2>
