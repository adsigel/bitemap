  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 text-sm text-stone-700">
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-stone-900">The basics</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-stone-900">Uploading sandwiches</h2>
