...
export function DailyLeaderboard({ entries, isFinal }: Props) {
        ...
        <ol className="space-y-2 text-left">
          {entries.map((e) => (
            <li key={e.id}>
              ...
              >
                <span className="w-6 shrink-0 text-center text-sm font-bold text-stone-400">{e.rank}</span>
                <div
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-stone-400">
                    {e.biteCount} {e.biteCount === 1 ? "bite" : "bites"} today
                  </p>
                </div>
              </a>
            </li>
